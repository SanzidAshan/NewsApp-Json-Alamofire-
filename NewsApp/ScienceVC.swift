//
//  EntertaimentVC.swift
//  NewsApp
//
//  Created by Sanzid Ashan on 5/5/17.
...
class ScienceVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let passData = MainStoryboard.instantiateViewController(withIdentifier: "ScienceDetailView") as! ScienceDetailView
